...
class PrintSubArraySumSolution1Test {

    @Test
    void testPrintSubArrayElementSum_singleElementArray() {
        PrintSubArraySumSolution1 printSubArraySum = new PrintSubArraySumSolution1();
        int[] array = {1};
        ...
        try {
            ...
            String expectedOutput = "Sum of subArray [0, 0] is 1\n";
    ...
    void testPrintSubArrayElementSum_multipleElementsArray() {
        ...
        try {
            printSubArraySum.printSubArrayElementSum(array);
            String expectedOutput = "Sum of subArray [0, 0] is 1\n" +
                    "Sum of subArray [0, 1] is 3\n" +
                    "Sum of subArray [0, 2] is 6\n" +
                    "Sum of subArray [1, 1] is 2\n" +
                    "Sum of subArray [1, 2] is 5\n" +
                    "Sum of subArray [2, 2] is 3\n";
            assertEquals(expectedOutput, outContent.toString());
        } finally {
            System.setOut(originalOut);
        }
